...
public class Client {
    ...
    public static UIResponse process(UIRequest uiRequest) throws IOException, ClassNotFoundException {
        ...
        if(uiRequest.getCode() == UIRequestCode.SIGN_UP) {
            String email = uiRequest.getData("email");
            String username = uiRequest.getData("username");
            String password = uiRequest.getData("password");
            String tel = uiRequest.getData("tel");
